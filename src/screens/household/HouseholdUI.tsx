...
export function Header({ title, onBack }: { title: string; onBack(): void }) { return <View style={styles.header}><Text style={styles.title}>{title}</Text><Pressable onPress={onBack} hitSlop={10} style={styles.back}><Image source={Images.backIcon} style={styles.backIcon} /></Pressable></View>; }
