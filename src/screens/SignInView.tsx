...
export function SignInView({ onGoogle }: { onGoogle(): void }) { useScreenTracking('SignIn');
  return <AppImageBackground source={Images.signInBg} resizeMode="cover" style={styles.root}><View style={styles.actions}><Pressable onPress={onGoogle} style={styles.google}><AppImage source={Images.googleLogo} style={styles.logo} /><Text style={styles.googleText}>Sign in with Google</Text></Pressable></View></AppImageBackground>;
}
